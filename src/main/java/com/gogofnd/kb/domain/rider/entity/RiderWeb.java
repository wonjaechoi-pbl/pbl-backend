...
import com.gogofnd.kb.domain.rider.repository.RiderWebRepositorySupport;
...
public class RiderWeb extends BaseTimeEntity implements UserDetails {
    ...
    @Column(length = 1)
    private Integer status; // 1활동, 0탈퇴
    ...
    public static RiderWeb create(KbApiWebReq req, Seller seller, String rawSsn) {
        //아이디 중복 방지
        ...
        return RiderWeb.builder()
                ...
                .phone(req.getDriver_phone().substring(0, 11)) //수정필요
    ...
    public void updateRequestData(KbApiWebReq req){
        this.gender = req.getDriver_gender();
        this.region = req.getDriver_region();
        this.vcNumber = req.getDriver_vcnum();
        this.phone = req.getDriver_phone();
        this.ssn = req.getDriver_ssn();
        this.name = req.getDriver_name();
        this.mtdt = req.getMtdt();
        this.oprn_purp = req.getOprn_purp();
    }
